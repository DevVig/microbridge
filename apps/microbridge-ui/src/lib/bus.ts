...
const DEMO: Snapshot = {
  sessions: [
    ...
    },
    {
      id: "s3",
      app: "Conductor",
      title: "workspace — onboarding empty states",
      state: "thinking",
  ...
  adapters: [
    ...
    },
    {
      ...
      diagnostic: "Built-in host attribution is active for Codex and Claude sessions.",
    },
    {
      id: "conductor",
      ...
      diagnostic: "Built-in host attribution is active for Conductor workspaces.",
    },
    {
      id: "cursor",
      display_name: "Cursor",
